...
Public Class FlushMemory
	...
	Public Declare Function SetProcessWorkingSetSize Lib "kernel32.dll" (proc As IntPtr, min As Integer, max As Integer) As Boolean

	' Token: 0x06000005 RID: 5 RVA: 0x00002094 File Offset: 0x00000294
	Public Shared Sub Flush()
		GC.Collect()
		GC.WaitForPendingFinalizers()
		Dim flag As Boolean = Environment.OSVersion.Platform = PlatformID.Win32NT
		If flag Then
			FlushMemory.SetProcessWorkingSetSize(Process.GetCurrentProcess().Handle, -1, -1)
		End If
	End Sub
End Class
